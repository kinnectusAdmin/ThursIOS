...
class PasswordResetPageVC: UIViewController {
    ...
    let vcs: [UIViewController] = {
        let vc1 = PasswdResetVC()
            vc1.view.tag = 0
        let vc2 = EnterPasswdVC()
            vc2.view.tag = 1
        let vc3 = ConfirmPasswdVC()
            vc3.view.tag = 2
        return [vc1,vc2,vc3]
    }()
...
extension PasswordResetPageVC : UIPageViewControllerDataSource{
