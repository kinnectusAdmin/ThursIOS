...
class EnterPasswdVC: UIViewController {
    ...
    func setViews(){
        ...
        self.view.add(views: passwdLabel,passwdField,enterButton)
        ...
        enterButton.setTopTo(con: passwdField.bottom(), by: 20)
    ...
    let passwdLabel: UILabel = {
        ...
        let attTxt = NSAttributedString(string: "Enter Password", attributes: atts)
        let lab = UILabel()
    ...
    let enterButton: UIButton = {
        let btn = UIButton()
        btn.setImage(#imageLiteral(resourceName: "SureButton"), for: .normal)
